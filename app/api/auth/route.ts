...
function configError(error:unknown){
 ...
 if(message.includes('[PGRST205]')||message.includes('[42P01]'))return 'Supabase đang trỏ tới project không có bảng public.ksnk_settings. Kiểm tra NEXT_PUBLIC_SUPABASE_URL.';
